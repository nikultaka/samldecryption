...
class OneLogin_Saml2_Auth
{
     ...
     */
    public function processResponse($requestId = null,$response)
    {
        $this->_errors = array();
        $this->_errorReason = null;
        if (isset($response)) { //$_POST['SAMLResponse']
            // AuthnResponse -- HTTP_POST Binding
            $response = new OneLogin_Saml2_Response($this->_settings,$response); // $_POST['SAMLResponse']
